...
{
	public class ServiceRequestContextWrapperServiceFabricPeople : FG.ServiceFabric.Services.Remoting.FabricTransport.ServiceRequestContextWrapper
	{
		public ServiceRequestContextWrapperServiceFabricPeople() { }
		public ServiceRequestContextWrapperServiceFabricPeople(string correlationId, string userId)
		{
