	...
	internal sealed class ActorLogger : IActorLogger
	{
			...
			string stateName)
		{
		    return new ScopeWrapper(new IDisposable[]
		    {
		        ...
		        {
			PersonActorEventSource.Current.StartReadState(
				_actor, 
				stateName
			);
		            ...
		            {
			PersonActorEventSource.Current.StopReadState(
				_actor, 
				stateName
			);
			...
			string stateName)
		{
		    return new ScopeWrapper(new IDisposable[]
		    {
                ...
                ScopeWrapperWithAction.Wrap(() =>
		        {
			PersonActorEventSource.Current.StartWriteState(
				_actor, 
				stateName
			);
		            ...
		            return new ScopeWrapperWithAction(() =>
		            {
			PersonActorEventSource.Current.StopWriteState(
				_actor, 
				stateName
			);
		...
		public void ActorHostInitializationFailed(
			System.Exception ex)
		{
			PersonActorEventSource.Current.ActorHostInitializationFailed(
				_actor, 
				ex
			);
