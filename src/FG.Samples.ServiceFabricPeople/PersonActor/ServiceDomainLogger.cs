...
namespace PersonActor
{
	internal sealed class ServiceDomainLogger : IServiceDomainLogger
	{
		...
		public void PersonGenerated(
			...
			string title)
		{
			PersonActorEventSource.Current.PersonGenerated(
				_actorService, 
				_context, 
				name, 
				title
			...
			)
		{
		    return new ScopeWrapper(new IDisposable[]
		    {
		        ...
		        {
			PersonActorEventSource.Current.StartRunAsyncLoop(
				_actorService, 
				_context
			);
		            ...
		            {
			PersonActorEventSource.Current.StopRunAsyncLoop(
				_actorService, 
				_context
			);
		...
		public void RunAsyncLoopFailed(
			System.Exception ex)
		{
			PersonActorEventSource.Current.RunAsyncLoopFailed(
				_actorService, 
				_context, 
				ex
			);
